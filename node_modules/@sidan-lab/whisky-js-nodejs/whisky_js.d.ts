...
* @returns {WasmResult}
*/
export function js_parse_tx_body(tx_hex: string, resolved_utxos: JsVecString): WasmResult;
/**
* @param {string} tx_hex
* @returns {WasmResult}
*/
export function js_get_tx_outs_utxo(tx_hex: string): WasmResult;
/**
* @param {string} tx_hex
* @returns {WasmResult}
*/
export function js_get_required_inputs_to_resolve(tx_hex: string): WasmResult;
/**
...
* @param {string} slot_config
* @returns {WasmResult}
*/
export function js_evaluate_tx_scripts(tx_hex: string, resolved_utxos: JsVecString, additional_txs: JsVecString, network: string, slot_config: string): WasmResult;
/**
* @param {string} tx_hex
* @returns {WasmResult}
*/
...
* @returns {string}
*/
export function js_apply_params_to_script(plutus_script: string, params: JsVecString, param_type: string): string;
/**
* @param {string} bech32_addr
* @returns {WasmDeserializedAddress}
*/
export function deserialize_bech32_address(bech32_addr: string): WasmDeserializedAddress;
/**
...
/**
*/
export class WasmDeserializedAddress {
  free(): void;
/**
...
* @returns {WasmDeserializedAddress}
*/
  static new(pub_key_hash: string, script_hash: string, stake_key_hash: string, stake_key_script_hash: string): WasmDeserializedAddress;
/**
* @returns {string}
*/
