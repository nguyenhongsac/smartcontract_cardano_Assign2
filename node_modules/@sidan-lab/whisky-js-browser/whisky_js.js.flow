/**
 * Flowtype definitions for whisky_js
 ...
 * @returns {WasmResult}
 */
declare export function js_parse_tx_body(
  tx_hex: string,
 ...
 * @returns {WasmResult}
 */
declare export function js_get_tx_outs_utxo(tx_hex: string): WasmResult;

/**
 * @param {string} tx_hex
 * @returns {WasmResult}
 */
declare export function js_get_required_inputs_to_resolve(
  tx_hex: string
): WasmResult;
 ...
 * @returns {WasmResult}
 */
declare export function js_evaluate_tx_scripts(
  tx_hex: string,
  resolved_utxos: JsVecString,
...
/**
 */
declare export class WasmDeserializedAddress {
  free(): void;
