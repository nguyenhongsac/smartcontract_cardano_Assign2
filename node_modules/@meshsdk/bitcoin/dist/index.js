...
var EmbeddedWallet = /*#__PURE__*/ function() {
   ...
   */ key: "signTx",
            value: function signTx(payload) {
                ...
                var ecPair = ECPair.fromPrivateKey(this._wallet.privateKey, {
                    network: this._network
                });
                var _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
                try {
                    for(var _iterator = payload.inputs[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
                ...
                try {
                    for(var _iterator1 = payload.outputs[Symbol.iterator](), _step1; !(_iteratorNormalCompletion1 = (_step1 = _iterator1.next()).done); _iteratorNormalCompletion1 = true){
